...
const ptBR = {
  ...
  'flow.transactionRouteComposition': 'Rota de transação composta deterministicamente a partir do caminho principal "{main}" e dos eventos específicos deste caminho.',
  ...
  'observation.deterministicAssumption': 'Observação gerada deterministicamente a partir de OCR, geometria e heurísticas de fluxo.',
  ...
  'observation.areaTextDemoted': 'Normalizado para structural porque a label também aparecia como touch point.',
  'observation.touchPointTextDemoted': 'Normalizado para structural porque a label não está entre os touch points válidos ou colide com área/contexto.',
  'observation.eventTextDemoted': 'Normalizado para uncertain porque não está em textsOutsideShapes ou colide com área/contexto.',
  'command.derivedFromTouchPoint': 'Command "{command}" derivado deterministicamente da label do ponto de contato "{touchPoint}" usando verbo {verb} e slug do objeto de domínio.',
...
const en: Record<I18nKey, string> = {
  ...
  'flow.transactionRouteComposition': 'Transaction route deterministically composed from the main path "{main}" and this path-specific events.',
  ...
  'observation.deterministicAssumption': 'Observation generated deterministically from OCR, geometry and flow heuristics.',
  ...
  'observation.areaTextDemoted': 'Normalized to structural because the label also appeared as a touch point.',
  'observation.touchPointTextDemoted': 'Normalized to structural because the label is not among valid touch points or collides with area/context.',
  'observation.eventTextDemoted': 'Normalized to uncertain because it is not in textsOutsideShapes or collides with area/context.',
  'command.derivedFromTouchPoint': 'Command "{command}" deterministically derived from the touch point label "{touchPoint}" using verb {verb} and a slug of the domain object.',
