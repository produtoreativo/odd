...
- preserve `stage` como agrupador de domain model, não como nome literal de processo ou touch point
- prefira nomes curtos de domínio em `stage`, como `Cliente`, `Cobrança`, `Pagamento`, `Fatura`
